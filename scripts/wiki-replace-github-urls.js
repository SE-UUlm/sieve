 ...
 * Source: https://github.com/SE-UUlm/snowballr-backend/blob/develop/scripts/wiki-replace-github-urls.js
 */
...
async function processFile(filePath) {
    try {
        ...
        let updatedContent = content.replace(
            /https:\/\/github\.com\/SE-UUlm\/sieve\/blob\/develop\//g,
            `https://github.com/SE-UUlm/sieve/blob/${targetBranch}/`,
        );

        // Replace GitHub Tree URLs
        updatedContent = updatedContent.replace(
            /https:\/\/github\.com\/SE-UUlm\/sieve\/tree\/develop\//g,
            `https://github.com/SE-UUlm/sieve/tree/${targetBranch}/`,
        );

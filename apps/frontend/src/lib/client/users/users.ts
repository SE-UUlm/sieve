...
export type userControllerGetUsersResponseError = (userControllerGetUsersResponse401 | userControllerGetUsersResponse403) & {
  headers: Headers;
};

export type userControllerGetUsersResponse = (userControllerGetUsersResponseSuccess | userControllerGetUsersResponseError)
...
export const userControllerGetUsers = async (params: UserControllerGetUsersParams, options?: RequestInit): Promise<userControllerGetUsersResponse> => {
...
export const getUserControllerGetUsersQueryOptions = <TData = Awaited<ReturnType<typeof userControllerGetUsers>>, TError = void>(params: UserControllerGetUsersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userControllerGetUsers>>, TError, TData>, fetch?: RequestInit}
) => {
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getUserControllerGetUsersQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof userControllerGetUsers>>> = ({ signal }) => userControllerGetUsers(params, { signal, ...fetchOptions });
...
export function useUserControllerGetUsers<TData = Awaited<ReturnType<typeof userControllerGetUsers>>, TError = void>(
 params: UserControllerGetUsersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userControllerGetUsers>>, TError, TData>, fetch?: RequestInit}
...
export type userControllerGetUserByIdResponseError = (userControllerGetUserByIdResponse401 | userControllerGetUserByIdResponse403 | userControllerGetUserByIdResponse404) & {
  headers: Headers;
};

export type userControllerGetUserByIdResponse = (userControllerGetUserByIdResponseSuccess | userControllerGetUserByIdResponseError)
...
export const userControllerGetUserById = async (userId: string, options?: RequestInit): Promise<userControllerGetUserByIdResponse> => {
...
export const getUserControllerGetUserByIdQueryOptions = <TData = Awaited<ReturnType<typeof userControllerGetUserById>>, TError = void>(userId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userControllerGetUserById>>, TError, TData>, fetch?: RequestInit}
) => {
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getUserControllerGetUserByIdQueryKey(userId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof userControllerGetUserById>>> = ({ signal }) => userControllerGetUserById(userId, { signal, ...fetchOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(userId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof userControllerGetUserById>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useUserControllerGetUserById<TData = Awaited<ReturnType<typeof userControllerGetUserById>>, TError = void>(
 userId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof userControllerGetUserById>>, TError, TData>, fetch?: RequestInit}

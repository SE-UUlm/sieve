...
/**
 * Creates the OpenAPI document for the SIEVE backend.
 *
 * This function creates a Swagger document that combines the OpenAPI schema generated by NestJS and the OpenAPI schema
 * generated by the Better Auth plugin.
 *

...
See below for a list of all available environment variables.
...
| `SMTP_FROM`                   |                    |            -            | SMTP from address for email sending.                                                              |
| `AUTO_SEND_RESPOND_THRESHOLD` | :white_check_mark: |            -            | Threshold of the confidence score for auto-sending email responses (0-100). Set to -1 to disable. |
...
| Variable              |      Required      | Default | Description                                                    |
| --------------------- | :----------------: | :-----: | -------------------------------------------------------------- |
| `PRODUCT_DB_USERNAME` | :white_check_mark: |    -    | The username for the database for product search of the agent. |
| `PRODUCT_DB_PASSWORD` | :white_check_mark: |    -    | The password for the database for product search of the agent. |
| `PRODUCT_DB_HOST`     | :white_check_mark: |    -    | The host of the database for product search of the agent.      |
| `PRODUCT_DB_PORT`     | :white_check_mark: |    -    | The port of the database for product search of the agent.      |
| `PRODUCT_DB_NAME`     | :white_check_mark: |    -    | The name of the database for product search of the agent.      |
